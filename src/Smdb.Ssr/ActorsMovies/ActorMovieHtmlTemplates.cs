...
public class ActorMovieHtmlTemplates
{
	public static string ViewAllMoviesByActor(Actor actor, List<(ActorMovie, Movie)> amms, int totalCount, int page, int size)
	{
        ...
        <tr>
          ...
          <td>{am.RoleName}</td>
          <td>
            <form action=""/actors/movies/remove?amid={am.Id}"" method=""POST"" onsubmit=""return confirm('Are you sure that you want to delete this movie from the actor?')"">
	...
	public static string ViewAllActorsByMovie(Movie movie, List<(ActorMovie, Actor)> amas, int totalCount, int page, int size)
	{
        ...
        <tr>
          ...
          <td>{am.RoleName}</td>
          <td>
            <form action=""/movies/actors/remove?amid={am.Id}"" method=""POST"" onsubmit=""return confirm('Are you sure that you want to delete this actor from the movie?')"">
              <input type=""submit"" value=""Remove"">
            </form>
          </td>
        </tr>
